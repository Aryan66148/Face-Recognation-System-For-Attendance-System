...
def err_screen():
    ...
    sc1.title("Warning!!")
    sc1.configure(bg="#1e1e2d")
    sc1.resizable(0, 0)
    tk.Label(sc1, text="Enrollment & Name required!", fg="#ffdd57", bg="#1e1e2d", font=("Arial", 18, "bold")).pack(pady=20)
    tk. Button(sc1, text="OK", command=del_sc1, fg="white", bg="#ff6f61", font=("Arial", 12, "bold"), relief="flat", width=10).pack()
